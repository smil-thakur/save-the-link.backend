...
func PageRoutes(r gin.IRoutes, pageController *pagecontroller.PageController) {
	...
	r.POST("/pages/:id/bookmark", pageController.BookmarkPage)
	r.DELETE("/pages/:id/bookmark", pageController.UnbookmarkPage)
	r.GET("/bookmarks", pageController.ListBookmarks)
